<?php /* Smarty version Smarty-3.0.8, created on 2015-03-17 09:35:00
         compiled from "C:\wamp\api/tpl\user/advertiser/product.php" */ ?>
<?php /*%%SmartyHeaderCode:283665507e734d40eb1-20070726%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '716d863cc110a9f27566450f1f8a86e6f61b22ef' => 
    array (
      0 => 'C:\\wamp\\api/tpl\\user/advertiser/product.php',
      1 => 1389583000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '283665507e734d40eb1-20070726',
  'function' => 
  array (
  ),
...
<html>
 ...
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
  ...
  <body>
     <!-- load head tpl -->
    <?php $_template = new Smarty_Internal_Template("./user/inner-head.php", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
      ...
      <div class="container">
        <div class="row-fluid">
          <div class="span3 left-bar" >
              <!-- load user tpl -->
            <?php $_template = new Smarty_Internal_Template("./user/inner-user.php", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
            <!-- Bootstrap -->
              ...
              <div class="row-fluid category">
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo $_smarty_tpl->getVariable('productCount')->value;?>
</p>
                  </div>
                ...
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo sprintf("%.2f",(0.01*$_smarty_tpl->getVariable('sumFee')->value));?>
&nbsp;&yen;</p>
                  </div>
              ...
              <div class="row-fluid category">
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo number_format($_smarty_tpl->getVariable('sumImpression')->value);?>
</p>
                  </div>
                ...
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo number_format($_smarty_tpl->getVariable('sumClick')->value);?>
</p>
                  </div>
              ...
              <div class="row-fluid category">
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo sprintf('%.2f',(0.01*$_smarty_tpl->getVariable('impressPrice')->value));?>
&nbsp;&yen;/次</p>
                  </div>
                ...
                <div class="span6 row-fluid category">
                  ...
                  <div class="span10">
                    ...
                    <p><?php echo sprintf("%.2f",(0.01*$_smarty_tpl->getVariable('clickPrice')->value));?>
&nbsp;&yen;/次</p>
                  </div>
                          ...
                          <td>
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                              <div class="fileupload-new thumbnail" style="border:solid 1px #ccc;width: 50px; height: 50px;background-color:#ededed;">
                                <img src="/img/show/<?php echo $_smarty_tpl->tpl_vars['product']->value['shown'];?>
" />
                              </div>
                              <div class="fileupload-preview fileupload-exists thumbnail" style="width: 50px; height: 50px;"></div>
                              <div>
                                <form method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'updateShown'),$_smarty_tpl);?>
...
"/>
                          ...
                          <td>
                              <p class="title" ><a class="editable"
                               data-pk="<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
"
...
"
                              ...
                              <p data-pk="<?php echo $_smarty_tpl->tpl_vars['product']->value['id'];?>
"><strong>广告内容：</strong>
                          ...
                          <td>
                            <?php echo number_format($_smarty_tpl->tpl_vars['product']->value['impression']);?>

                          </td>
                           <td>
                           
                            <?php echo number_format($_smarty_tpl->tpl_vars['product']->value['click']);?>

                          </td>
                          <td>
                           
                            <?php echo sprintf('%.2f',(($_smarty_tpl->tpl_vars['product']->value['click']/$_smarty_tpl->tpl_vars['product']->value['impression'])*100));?>
%
                          </td>
                          <td>
                           
                            <?php echo sprintf("%.2f",(0.01*$_smarty_tpl->tpl_vars['product']->value['fee']));?>
&yen;
                          </td>
                          <td>
                           
                            <?php echo sprintf('%.2f',(0.01*$_smarty_tpl->tpl_vars['product']->value['fee']/$_smarty_tpl->tpl_vars['product']->value['click']));?>
 &yen;/次
                          </td>
                          <td>
                           <?php if ($_smarty_tpl->tpl_vars['product']->value['canRemove']==1){?>
                           
                             <a url="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'removeProduct','productID'=>$_smarty_tpl->tpl_vars['product']->value['id']),$_smarty_tpl);?>
"
                             ...
                             <?php }else{ ?>
                             <a url="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'removeProduct','productID'=>$_smarty_tpl->tpl_vars['product']->value['id']),$_smarty_tpl);?>
" class="btn btn-mini btn-danger disabled tip" title="正在推广的产品无法删除">
                              <i class=" icon-trash"></i>
                            </a>
                            <?php }?>
...
<div class="modal hide fade" id="form-addProject">
  <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'addProduct'),$_smarty_tpl);?>
    ...
    <div class="modal-body" style="padding:0px 20px;">
      <div class="row-fluid">
        ...
        <div class="span3 offset1">
          <p>
            <div  align="center">
              <form id="headimgform" method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'tool','a'=>'upFile'),$_smarty_tpl);?>
" enctype="multipart/form-data"> 
...
<div class="modal hide fade" id="form-confirm" style="top:10%;">
  ...
  <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'removeProduct'),$_smarty_tpl);?>
...
<div class="modal hide fade" id="form-txt-content" style="top:10%;">
    ...
    <div class="modal-body">
                  ...
                  <div>
                    <form id="txtform" method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'upDateAdTxt'),$_smarty_tpl);?>
" enctype="multipart/form-data"> 
                       <h6>
                        广告文字预览：
                      </h6>
...
<div class="modal hide fade" id="form-image-content" style="top:10%;">
    ...
    <div class="modal-body">
                  ...
                  <div>
                    <form id="imageform" method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'uploadAdImage'),$_smarty_tpl);?>
" enctype="multipart/form-data"> 
                       <h6>
                        图片缩略图：
                      </h6>
...
<div class="modal hide fade" id="form-video-content" style="top:20%;">
    ...
    <div class="modal-body">
                  ...
                  <div>
                    ...
                    <form id="videoform" method="post" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'uploadAdVideo'),$_smarty_tpl);?>
" enctype="multipart/form-data"> 
                      <h6>
                          广告视频预览：
                      </h6>
...
$('.select-editable').editable({
        disabled:true,  
        url: '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproject','a'=>'UpdateProject'),$_smarty_tpl);?>
',
...
, text:"<?php echo $_smarty_tpl->tpl_vars['category']->value['name'];?>
"},
               <?php }} ?>
           ] 
    }); 
...
',
 ...
 $('.url-editable').editable({
        ...
        disabled:true,
        emptytext:'空数据',
        url: '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'updateProduct'),$_smarty_tpl);?>
',
        success: function(response, newValue) {
          if(!response.success) 
             $.msg('编辑成功！','color:green;');
...
$(".btn-txt-content").click(function(){
  ...
  var currentProduct;
  $.post("<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'getJsonProduct'),$_smarty_tpl);?>
",{id:key},function(data,status){
...
',
  ...
  $.ajax({ url: "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'cproduct','a'=>'getJsonData'),$_smarty_tpl);?>
", success: function(data){
